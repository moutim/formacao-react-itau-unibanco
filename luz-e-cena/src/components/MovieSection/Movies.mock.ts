...
const movies: Movie[] = [
    {
        id: 1,
        src: "/assets/imagens/Cards filmes/Card - Amigo da sombra.png",
    ...
    {
        id: 3,
        src: "/assets/imagens/Cards filmes/Card - Caminho para o abismo.png",
    ...
    {
        id: 5,
        src: "/assets/imagens/Cards filmes/Card - Mestres do futuro.png",
    ...
    {
        id: 7,
        src: "/assets/imagens/Cards filmes/Card - La Esperanza.png",
    ...
    {
        id: 8,
        src: "/assets/imagens/Cards filmes/Card - O nexus do tempo.png",
